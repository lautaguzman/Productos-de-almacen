...
function validarForm(event) {
  ...
  if (name === "") {
    mostrarMensajeError(
      "Por favor, complete el campo de nombre antes de enviar el formulario."
    );
    return;
  }
  ...
  if (mje === "") {
    mostrarMensajeError(
      "Por favor, complete el campo de mensaje antes de enviar el formulario."
    );
    return;
